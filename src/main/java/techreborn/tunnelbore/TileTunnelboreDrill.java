...
public class TileTunnelboreDrill extends TileEntity {

	public EnumFacing drillDirection = EnumFacing.NORTH;

	public void update(){
		if(!world.isRemote){
			Set<BlockPos> targetBlocks = getTargetBlocks(world, getPos().offset(drillDirection));
	...
	public Set<BlockPos> getTargetBlocks(World worldIn, BlockPos pos) {
		...
		EnumFacing enumfacing = drillDirection;
